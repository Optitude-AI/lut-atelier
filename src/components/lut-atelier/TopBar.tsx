        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="h-8 px-2 text-zinc-400 hover:text-white disabled:opacity-30"
              disabled={!canUndo}
              onClick={handleUndo}
            >
          ...
          <TooltipContent side="bottom" className="text-xs">
            Undo <kbd className="ml-1.5 px-1 py-0.5 bg-zinc-800 border border-zinc-700 rounded text-[10px] font-mono">⌘Z</kbd>
          </TooltipContent>
        </Tooltip>
